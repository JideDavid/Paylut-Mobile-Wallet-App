...
class Withdraw extends StatefulWidget {
  ...
  const Withdraw({super.key, required this.userDetails});

  @override
  // ignore: no_logic_in_create_state
  State<Withdraw> createState() => _WithdrawState(userDetails: userDetails);
}

class _WithdrawState extends State<Withdraw> {
  final UserDetails userDetails;
  _WithdrawState({required this.userDetails});
