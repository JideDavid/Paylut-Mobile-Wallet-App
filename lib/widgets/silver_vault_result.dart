...
class SilverVaultResult extends StatefulWidget {
  final UserDetails userDetails;
  const SilverVaultResult({super.key, required this.userDetails});

  @override
  // ignore: no_logic_in_create_state
  State<SilverVaultResult> createState() => _SilverVaultResultState(userDetails: userDetails);
}

class _SilverVaultResultState extends State<SilverVaultResult> {
  UserDetails userDetails;
  _SilverVaultResultState({required this.userDetails});
