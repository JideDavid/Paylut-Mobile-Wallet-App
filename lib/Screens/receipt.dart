...
class Receipt extends StatefulWidget {
  ...
  const Receipt({super.key, required this.userDetails, required this.transactionRef});

  @override
  State<Receipt> createState() =>
      // ignore: no_logic_in_create_state
      _ReceiptState(userDetails: userDetails, transactionRef: transactionRef);
}

class _ReceiptState extends State<Receipt> {
  UserDetails userDetails;
  String transactionRef;
  _ReceiptState({required this.userDetails, required this.transactionRef});
