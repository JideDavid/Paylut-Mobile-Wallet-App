...
class GiftFriend extends StatefulWidget {
  ...
  const GiftFriend({super.key, required this.userDetails});

  @override
  // ignore: no_logic_in_create_state
  State<GiftFriend> createState() => _GiftFriendState(userDetails: userDetails);
}

class _GiftFriendState extends State<GiftFriend> {
  UserDetails userDetails;
  _GiftFriendState({required this.userDetails});
    ...
    return Scaffold(
      appBar: AppBar(
        title: Column(
          ...
          children: [
            Text("Gift Friend", style: heading,),
            Text("Send any of our services as gifts to your loved ones", style: subHeading,)
          ],
        ),
        actions: [
          IconButton(
